...
instead. Never join independent clauses with `, while`; keep only the higher-priority claim.
Write every fact as a complete sentence of at most 160 characters ending in `.`, `?`,
