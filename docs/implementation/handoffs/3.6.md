...
- Prior docs commit: `8b24c7e93ac83b6eec70418ea011decef3618221` / tree
...
- Review-record docs commit: `SELF`; tree: `SELF_TREE`.
...
1. In `src/oms_hub/models.py`, add central ORM classes with the same table/column contract
   ...
   schema_version, model, validation_outcome, expected_evidence_count, created_at)`; and
