...
initialize probe executed but failed at hostname discovery; the root cause must
be corrected and reviewed before a fresh retry. The two Windows arg0 tests remain
