...
def test_ankiconnect_methods_emit_v6_contract_at_nuc_loopback(
    method_name: str,
    arguments: tuple[Any, ...],
    action: str,
    params: dict[str, Any],
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        assert str(request.url) == ANKI_CONNECT_URL
...
def test_ankiconnect_rejects_every_noncanonical_url(url: str) -> None:
